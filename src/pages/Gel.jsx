  ...
  return (
    <div className="page-container">
      ...
      <p>
        ...
        <span className="hover-word">Gel electrophoresis</span>
        <img
          src={require("../gel-diagram.webp")}
          alt="Gel Electrophoresis Diagram"
          className="overlay-image"
        />
      </span> is a technique used to separate DNA fragments based on size. 
        In this process, molecules are loaded into a gel matrix and an electric current is applied.
        Since DNA is <span className="hover-reveal">
        <span className="hover-word">negatively charged</span>
        <img
          src={require("../dna-diagram.png")}
          alt="CRISPR Diagram"
          className="overlay-image"
        />
      </span> due to its phosphate groups, the fragments will travel from the negative end to the positive end of the gel. 
      ...
      <p>
        ...
        Despite being a {""}
        <span className="hover-reveal">
          <span className="hover-word">decades-old technique</span>
          <span className="overlay-reveal">
            gel electrophoresis first emerged in the 1960s
          </span>
        </span>{""}, gel electrophoresis remains a reliable and essential tool in molecular biology, providing a clear and visual way to analyze biological molecules.
      </p>
