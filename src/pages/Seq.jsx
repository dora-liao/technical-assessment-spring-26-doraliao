...
export default function Seq({ userId }) {
  return (
    <div className="page-container">
      ...
      <p>
        Sanger sequencing, developed in the 1970s, was the first widely adopted method for reading DNA. 
        It uses modified nucleotides to terminate DNA synthesis at specific points, generating fragments of different lengths 
        ...
        for smaller DNA fragments or targeted gene analysis rather than large-scale genome projects. 
      ...
      <p>
        Next-generation sequencing (NGS) refers to a collection of modern high-throughput methods that can sequence millions of DNA fragments simultaneously. 
      ...
      <p>
        Nanopore sequencing is an innovative technology that reads DNA molecules directly as they pass through tiny protein pores-called nanopores-in a membrane. 
        ...
        Portable devices, like Oxford Nanopore’s MinION, have made it possible to sequence pathogens in the field.
      </p>
